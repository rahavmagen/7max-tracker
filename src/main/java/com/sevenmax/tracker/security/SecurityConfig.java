...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(a -> a
                .requestMatchers("/api/auth/login", "/api/auth/change-password", "/api/reports/upload-auto", "/api/kashcash/webhook", "/api/grow/webhook", "/api/deposit-automation/**").permitAll()
    ...
    public CorsConfigurationSource corsSource() {
        ...
        cfg.setAllowedOriginPatterns(List.of("http://localhost:5173", "http://localhost:5174", "https://*.vercel.app", "${FRONTEND_URL:}"));
