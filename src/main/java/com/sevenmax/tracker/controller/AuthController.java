...
public class AuthController {
    ...
    public ResponseEntity<Map<String, Object>> adminResetPassword(@RequestBody Map<String, String> body) {
        try {
    ...
    public ResponseEntity<Map<String, Object>> changeRole(@RequestBody Map<String, String> body) {
        try {
            authService.changeRole(body.get("username"), body.get("role"));
            return ResponseEntity.ok(Map.of("success", true));
        } catch (Exception e) {
            return ResponseEntity.badRequest().body(Map.of("error", e.getMessage()));
        }
